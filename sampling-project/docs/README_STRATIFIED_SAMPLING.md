...
Use this file as the top-level index. Detailed runbooks are split by experiment/UI:

- Experiment 1 (Budget-resolved paired run): `docs/experiments/README_EXPERIMENT_1_BUDGET_PAIRED.md`
- Experiment 2 (Stress-pool sweeps): `docs/experiments/README_EXPERIMENT_2_STRESS_SWEEPS.md`
- Experiment 3 (Harder-task pilot): `docs/experiments/README_EXPERIMENT_3_HARDER_TASK_PILOT.md`
- Experiment 4 (Feature ablation): `docs/experiments/README_EXPERIMENT_4_FEATURE_ABLATION.md`
- UI workflow: `docs/ui/README_UI_WORKFLOW.md`
